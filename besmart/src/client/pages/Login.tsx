...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (error === 'oauth_failed') {
      ...
      toast.error('This OAuth provider is not configured on the server.');
    }
  }, [searchParams]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Sign in to BeSmart</h1>
        </div>
          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              <a
                ...
                className="flex w-full items-center justify-center gap-2 py-2 border border-gray-200 rounded-xl text-sm text-gray-400 cursor-not-allowed pointer-events-none opacity-60"
                tabIndex={-1}
                aria-disabled="true"
              >
              ...
              <span className="absolute -top-2 -right-1 text-[10px] bg-gray-100 text-gray-400 rounded px-1 leading-4">soon</span>
            </div>
            <div className="flex-1 relative">
              <a
